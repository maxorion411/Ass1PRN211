...
namespace DataAccess
{
    public class MemberDAO
    {
        ...
        private static List<MemberObject> members = new List<MemberObject>
        {
            ...
            {
                MemberID = 2,
                MemberName = "Mạnh Hiếu",
                Email = "mhieu04@gmail.com",
                Password = "123456",
                City = "California",
            ...
            {
                MemberID = 3,
                MemberName = "Kiên Nguyễn",
                Email = "kienn88@gmail.com",
                Password = "abcxyz",
                City = "Ha Noi",
                Country = "Vietnam"
            },
            ...
            {
                MemberID = 4,
                MemberName = "Tuấn Nguyễn",
                Email = "tuannguyen983@hotmail.com",
                Password = "123456",
                City = "Texas",
                Country = "United States"
            },
            ...
            {
                MemberID = 5,
                MemberName = "Ngọc Linh",
                Email = "linhngoc04a@gmail.com",
                Password = "123456",
                City = "Tokyo",
                Country = "Japan"
            },
            ...
            {
                MemberID = 7,
                MemberName = "Linh Nguyễn",
                Email = "nguyenlinnh3334@gmail.com",
                Password = "123456",
                City = "Osaka",
                Country = "Japan"
            },
            ...
            {
                MemberID = 8,
                MemberName = "Quang Đạt",
                Email = "datq948@gmail.com",
                Password = "123456",
                City = "Ho Chi Minh",
                Country = "Vietnam"
            }
